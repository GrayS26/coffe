(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider")) {
            const mainSlider = new swiper_core_Swiper(".slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 800,
                navigation: {
                    prevEl: ".lider-min__arrow--arrow-left",
                    nextEl: ".lider-min__arrow--arrow-right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        if (document.querySelector(".slider-big")) {
            const mainSlider = new swiper_core_Swiper(".slider-big", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-big--arrow-left",
                    nextEl: ".slider-big--arrow-right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
